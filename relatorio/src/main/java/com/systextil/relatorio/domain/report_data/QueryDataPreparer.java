...
class QueryDataPreparer {
	...
	String findJoinsByTable(String table, String comparedTable, List<RelationshipData> relationshipsData) {
		StringBuilder joinBuilder = new StringBuilder();
	...
	String compareToMainTable(String mainTable, String firstTable, String lastTable, List<RelationshipData> relationshipsData) {
	...
	String compareToPreviousTablesPairs(Pattern lastTablePattern, int mainIndex, String firstTable, String lastTable, List<String> tablesPairs, List<RelationshipData> relationshipsData) {
		StringBuilder joinBuilder = new StringBuilder();
